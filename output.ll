...
@.str = private unnamed_addr constant [21 x i8] c"hi you are very cool\00", align 1
...
define dso_local void @hi(i8* %0, i8* %1) #0 {
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0))
  ret void
}
